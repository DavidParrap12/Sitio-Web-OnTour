      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 mt-3">
              ...
              <a href="https://api.whatsapp.com/send/?phone=573143415177" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#25D366] hover:text-white transition-colors">
            ...
            <div className="mt-6 pt-5 border-t border-gray-800">
              <p className="text-white/30 text-[10px] font-semibold uppercase tracking-[0.2em] mb-3">{t("partners")}</p>
              <div className="flex items-center gap-3">
                <div className="bg-white/90 rounded-lg px-3 py-1.5 flex items-center justify-center opacity-70 hover:opacity-100 transition-all duration-300">
                  <Image
                    src="/image/logo-aliados/assist-card.jpeg"
                    alt="Assist Card"
                    width={100}
                    height={28}
                ...
                <div className="bg-white/90 rounded-lg px-3 py-1.5 flex items-center justify-center opacity-70 hover:opacity-100 transition-all duration-300">
                  <Image
                    src="/image/logo-aliados/Procolombia.jpeg"
                    alt="Procolombia"
                    width={100}
                    height={28}
                    style={{ width: 'auto', height: '24px' }}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+573143415177" className="hover:text-accent transition-colors">+57 314 341 5177</a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="pt-6 border-t border-gray-800 text-center flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} Ontour DMC Colombia. {t("rights")}
          </p>
